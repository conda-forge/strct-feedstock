...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/strct-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11072&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/strct-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `strct` can be installed with:

```
conda install strct
```

It is possible to list all of the versions of `strct` available on your platform with:
